  ...
  const columns: any = [
            ...
            {record.isDirectory ? (
              ...
              <div className="svg-box file">
                <svg className="svg-icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M766.577778 884.622222h-440.888889c-31.288889 0-56.888889-25.6-56.888889-56.888889V462.222222c0-31.288889 25.6-56.888889 56.888889-56.888889h46.933333c15.644444 0 28.444444 12.8 28.444445 28.444445s-12.8 28.444444-28.444445 28.444444h-46.933333v365.511111h439.466667V554.666667h-28.444445c-15.644444 0-28.444444-12.8-28.444444-28.444445s12.8-28.444444 28.444444-28.444444h28.444445c31.288889 0 56.888889 25.6 56.888888 56.888889v273.066666c0 32.711111-24.177778 56.888889-55.466666 56.888889z"
                    fill="#3FA6AD"
                  ></path>
                  <path
                    d="M736.711111 556.088889H504.888889c-9.955556 0-18.488889-5.688889-24.177778-12.8l-49.777778-79.644445h-58.311111c-8.533333 0-17.066667-4.266667-22.755555-11.377777-5.688889-7.111111-7.111111-15.644444-5.688889-24.177778l35.555555-152.177778c2.844444-12.8 11.377778-25.6 22.755556-32.711111 11.377778-7.111111 25.6-9.955556 39.822222-5.688889L763.733333 312.888889c12.8 2.844444 25.6 11.377778 32.711111 22.755555 7.111111 11.377778 9.955556 25.6 5.688889 39.822223l-36.977777 157.866666c-2.844444 12.8-14.222222 22.755556-28.444445 22.755556z m-216.177778-56.888889h193.422223l31.288888-130.844444-310.044444-73.955556-27.022222 112.355556h38.4c9.955556 0 18.488889 5.688889 24.177778 12.8l49.777777 79.644444z"
                    fill="#3FA6AD"
                  ></path>
                  <path
                    d="M736.711111 556.088889H504.888889c-9.955556 0-18.488889-5.688889-24.177778-12.8l-49.777778-79.644445h-58.311111c-15.644444 0-28.444444-12.8-28.444444-28.444444s12.8-28.444444 28.444444-28.444444h73.955556c9.955556 0 18.488889 5.688889 24.177778 12.8l49.777777 79.644444h216.177778c15.644444 0 28.444444 12.8 28.444445 28.444444s-12.8 28.444444-28.444445 28.444445z"
                    fill="#3FA6AD"
                  ></path>
                  <path
                    d="M661.333333 449.422222c-2.844444 0-4.266667 0-7.111111-1.422222l-164.977778-39.822222c-15.644444-4.266667-24.177778-18.488889-21.333333-34.133334 4.266667-15.644444 18.488889-24.177778 34.133333-21.333333L668.444444 393.955556c15.644444 4.266667 24.177778 18.488889 21.333334 34.133333-2.844444 12.8-15.644444 21.333333-28.444445 21.333333z"
                    fill="#DC4569"
                  ></path>
                </svg>
              </div>
    ...
    },
    {
      ...
      render: (text: string = '', record: { [K: string]: any } = {}) => {
        ...
        // 非目录和非可执行文件
        if (!record.isDirectory && !record.executable) {
          hasPreview = true
        }
  ...
  const render = () => {
    ...
    return (
      <div className="archive-wrapper">
        ...
        {
          <Drawer
            title={homeStore.detailContent?.fileName || '文件'}
            placement="right"
